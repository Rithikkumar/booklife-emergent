...
-- Add community members without the trigger
...
-- Manually update member counts for each community
UPDATE communities SET member_count = 3 WHERE id = 'c1111111-1111-1111-1111-111111111111'::uuid; -- JavaScript Developers
UPDATE communities SET member_count = 4 WHERE id = 'c2222222-2222-2222-2222-222222222222'::uuid; -- Book Club Central
UPDATE communities SET member_count = 3 WHERE id = 'c3333333-3333-3333-3333-333333333333'::uuid; -- Local Coffee Enthusiasts
UPDATE communities SET member_count = 3 WHERE id = 'c4444444-4444-4444-4444-444444444444'::uuid; -- Fitness Motivation
UPDATE communities SET member_count = 2 WHERE id = 'c5555555-5555-5555-5555-555555555555'::uuid; -- Photography Showcase
