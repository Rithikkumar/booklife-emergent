            ...
            <CardContent>
              <div className="space-y-1">
                ...
                <SettingItem
                  ...
                  onChange={(value) => setSettings(prev => ({ ...prev, follows: value }))}
                />
                <Separator />
                <SettingItem
                  icon={Bell}
                  ...
                  onChange={(value) => setSettings(prev => ({ ...prev, bookClasses: value }))}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-1">
                ...
                <SettingItem
                  ...
                  onChange={(value) => setSettings(prev => ({ ...prev, twoFactorEnabled: value }))}
                />
              </div>
            </CardContent>
          </Card>
