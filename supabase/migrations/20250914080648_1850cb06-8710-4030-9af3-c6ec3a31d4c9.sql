...
-- "The Catcher in the Rye" by J.D. Salinger (2 in Beverly Hills, 1 in Culver City)
...
-- "Beloved" by Toni Morrison (1 in Beverly Hills, 2 in Culver City)
...
-- "The Bell Jar" by Sylvia Plath (Mixed Beverly Hills and Culver City)
  ((SELECT user_id FROM profiles WHERE username = 'charlie' LIMIT 1), 
