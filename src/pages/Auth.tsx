...
import { Mail, Lock, UserPlus, LogIn, ArrowLeft, BookOpen } from 'lucide-react';
...
const Auth: React.FC = () => {
  ...
  return (
    <ScrollRestoreLayout>
      <div className="max-w-md mx-auto mt-10 mb-12 md:mt-16 md:mb-16">
        <Link 
          to="/" 
        ...
        <Card>
          <CardHeader>
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-base text-muted-foreground">Join our community of book lovers</p>
            </div>
          </CardHeader>
          <CardContent>
