...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    // Check if we were directed here from the profile menu with a specific tab
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          {canViewContent && (
            ...
            >
              ...
              {activeTab === 'favorites' && isCurrentUserProfile && (
                <div className={`${
                  viewMode === 'grid'
                    ? 'grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'
                    : 'space-y-4'
                  ...
                  <div className="col-span-full flex items-center justify-center h-48 bg-muted rounded-lg border border-border">
                    <div className="text-center text-muted-foreground">
                      ...
                      <p className="text-sm mt-2">Mark books as favorites and they'll appear here</p>
                    </div>
                  </div>
                </div>
              )}
